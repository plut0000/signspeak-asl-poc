...
export const DEDICATED_MODEL_DIRNAME = "asl-citizen-bilstm100";
export const DEDICATED_MODEL_VERSION = "2.1.3";
export const DEDICATED_MODEL_VARIANT = "RL";
export const DEDICATED_MODEL_LABEL = "Model v2.1.3 (RL) 100-class";
export const DEDICATED_ONNX_FILENAME = "asl_citizen_bilstm100_rl.onnx";
