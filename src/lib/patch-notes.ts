...
export const PATCH_NOTES = {
  ...
  summary:
    "Gemini video now translates signed songs from vision only: silent clips, lyric-first prompts, no gang-sign or screen-recording lectures, and a faster lite-model path. The dedicated model remains the v2.1.2 50-class RL BiLSTM.",
  highlights: [
    ...
    "Long clips are faster: flash-lite only, no SDK retry storm, no second lyric round-trip when the first answer already looks like lyrics, 8 fps video sampling, thinking disabled. The v2.1.2 50-class BiLSTM and long-clip routing are unchanged.",
  ],
} as const;
