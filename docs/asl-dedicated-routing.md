...
1. Train offline → `models/asl-citizen-bilstm50/` (`*.pt`, `label_map50.json`, exported `*.onnx`). Demo **v2.1.2** loads `asl_citizen_bilstm50_rl.onnx`. v2.1.1 routing still skips BiLSTM for long clips.
