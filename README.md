...
3. Record / Stop (auto-stops after 7 seconds).
...
A 5–7 second 720p-or-smaller clip stays well under Gemini’s inline size limit, so this POC does **not** extract still frames or use the Files API.
